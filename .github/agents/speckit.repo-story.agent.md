...
Run `.documentation/scripts/powershell/repo-story-context.ps1 $ARGUMENTS -Json` to produce `history.json` and parse the JSON output for these top-level sections:
...
3. One-line takeaways:
   ...
   - Recommended next step (e.g., "Run `/speckit.site-audit` for code quality deep-dive")
