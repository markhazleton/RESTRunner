    ...
    public class CollectionController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            catch (Exception ex)
            {
                ...
                return View(new List<RequestSpark.Web.Models.CollectionMetadata>());
            }
        }
        ...
        public async Task<IActionResult> Upload(CollectionUploadViewModel viewModel)
        {
            ...
            try
            {
                ...
                // Create metadata
                var metadata = new RequestSpark.Web.Models.CollectionMetadata
                {
                    Name = viewModel.Name,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, RequestSpark.Web.Models.CollectionMetadata collection)
        {
            if (id != collection.Id)
                return NotFound();
